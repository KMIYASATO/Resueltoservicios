...
export function ServiceCard({
  ...
  return (
    <Link href="/resultados" className="group block rounded-lg focus-visible:outline focus-visible:outline-3 focus-visible:outline-offset-4 focus-visible:outline-brand-600/35">
      <Card className="overflow-hidden p-0 transition-[border-color,box-shadow,transform] duration-normal ease-standard group-hover:-translate-y-1 group-hover:border-brand-500 group-hover:shadow-md group-active:scale-[0.99]">
